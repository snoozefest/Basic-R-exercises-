...
#
# 2. Create a data frame of 15 Indian cities and their populaation size. Create a data frame of 15 Indian cities and their population size. You could refer cities and population from this page: http://worldatlas.com/articles/the-biggest-cities-in-india.html
#
